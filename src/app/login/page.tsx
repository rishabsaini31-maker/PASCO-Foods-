        ...
        <div className="w-full max-w-md px-6">
          <FadeUp>
            <div className="text-center mb-8">
              <h1 className="text-2xl md:text-3xl font-semibold text-[#1A1A1A]">Welcome Back</h1>
              <p className="mt-2 text-sm text-[#6B6B6B]">Sign in to your Pasco Foods account</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full h-11 px-4 text-sm border border-[#E5E2DB] rounded-lg focus:outline-none focus:border-[#214E34] focus:ring-1 focus:ring-[#214E34]"
                  placeholder="you@example.com"
                />
              </div>

              <div>
                <label htmlFor="login-password" className="block text-sm font-medium text-[#1A1A1A] mb-1.5">Password</label>
                <div className="relative">
                  <input
                    ...
                    className="w-full h-11 px-4 pr-11 text-sm border border-[#E5E2DB] rounded-lg focus:outline-none focus:border-[#214E34] focus:ring-1 focus:ring-[#214E34]"
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-[#E5E2DB] text-[#214E34] focus:ring-[#214E34]" />
                  <span className="text-sm text-[#6B6B6B]">Remember me</span>
                </label>
                <button type="button" onClick={() => alert('Password reset functionality coming soon.')} className="text-sm text-[#214E34] hover:text-[#9C3A28] font-medium transition-colors">
                  Forgot password?
                </button>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-[#6B6B6B]">
                ...
                <Link href="/signup" className="font-semibold text-[#214E34] hover:text-[#9C3A28] transition-colors">
                  Create Account
                </Link>
              </p>
            </div>
